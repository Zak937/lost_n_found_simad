        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon:
                  const Icon(Icons.search_rounded, color: Color(0xFF1A73E8)),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Center(
            child: Column(
              children: [
                ...
                Text(
                  user?.displayName ?? 'SIMAD Student',
          ...
          _profileTile(
              Icons.list_alt_rounded, 'My Posts', 'View your reported items',
